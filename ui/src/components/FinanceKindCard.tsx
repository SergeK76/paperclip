            ...
            >
              <div className="min-w-0">
                ...
                <div className="text-xs text-muted-foreground">
                  {t("costs:financeKind.eventsAndBillers", {
                    eventsStr: t("costs:financeKind.events", { count: row.eventCount }),
                    billersStr: t("costs:financeKind.billers", { count: row.billerCount }),
                  })}
                </div>
              </div>
              <div className="text-right tabular-nums">
                ...
                <div className="text-xs text-muted-foreground">
                  {formatCents(row.debitCents)} {t("costs:financeKind.debits")}
                </div>
              </div>
            </div>
          ))
