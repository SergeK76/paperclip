...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("common:nav.home"), icon: House },
      { type: "link", to: "/issues", label: t("common:nav.issues"), icon: CircleDot },
      { type: "action", label: t("common:nav.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("common:nav.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
