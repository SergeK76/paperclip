...
export function ApprovalCard({
  ...
  const kindLabel = t(`approvals:typeLabel.${approval.type}`, { defaultValue: typeLabel[approval.type] ?? approval.type });
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-5 text-muted-foreground">
                  {t("approvals:card.createdAt", { timeAgo: timeAgo(approval.createdAt) })}
                </p>
              </div>
            </div>
          </div>
