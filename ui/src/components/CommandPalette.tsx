  ...
  return (
    <CommandDialog open={open} onOpenChange={(v) => {
      ...
      <CommandList>
        ...
        <CommandGroup heading={t("common:commandPalette.actionsGroup")}>
          <CommandItem
            onSelect={() => {
              setOpen(false);
              openNewIssue();
          ...
          >
            ...
            {t("common:commandPalette.createIssue")}
          ...
          >
            ...
            {t("common:commandPalette.createAgent")}
          </CommandItem>
          <CommandItem onSelect={() => go("/projects")}>
            <Plus className="mr-2 h-4 w-4" />
            {t("common:commandPalette.createProject")}
          </CommandItem>
        </CommandGroup>

        <CommandSeparator />

        <CommandGroup heading={t("common:commandPalette.pagesGroup")}>
        ...
        {visibleIssues.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("common:commandPalette.issuesGroup")}>
        ...
        {agents.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("common:commandPalette.agentsGroup")}>
        ...
        {projects.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("common:commandPalette.projectsGroup")}>
