  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        <PropertyRow label={t("properties.rowLabel.level")}>
          {onUpdate ? (
            <PickerButton
              current={goal.level}
              options={GOAL_LEVELS}
        ...
        <PropertyRow label={t("properties.rowLabel.owner")}>
          {ownerAgent ? (
            <Link
            ...
            <span className="text-sm text-muted-foreground">{t("properties.placeholders.none")}</span>
          )}
        </PropertyRow>

        {goal.parentId && (
          <PropertyRow label={t("properties.rowLabel.parentGoal")}>
            <Link
