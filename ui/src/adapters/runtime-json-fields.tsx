...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("adapters:configFields.runtimeServicesJson")} hint={help.runtimeServicesJson}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label={t("adapters:configFields.payloadTemplateJson")} hint={help.payloadTemplateJson}>
      <textarea
