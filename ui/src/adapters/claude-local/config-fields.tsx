...
export function ClaudeLocalConfigFields({
  ...
  return (
    <>
      {!hideInstructionsFile && (
        <Field label={t("adapters:configFields.instructionsFile.label")} hint={t("adapters:configFields.instructionsFile.hintDefault")}>
...
export function ClaudeLocalAdvancedFields({
  ...
  return (
    <>
      ...
      />
      <Field label={t("adapters:configFields.maxTurnsPerRun")} hint={help.maxTurnsPerRun}>
        {isCreate ? (
          <input
            type="number"
            className={inputClass}
