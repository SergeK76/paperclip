...
export function Agents() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("common:nav.agents") }]);
  }, [setBreadcrumbs, t]);
  ...
  return (
    <div className="space-y-4">
            ...
            {filtersOpen && (
              <div className="absolute right-0 top-full mt-1 z-50 w-48 border border-border bg-popover shadow-md p-1">
                ...
                >
                  ...
                  {t("agents:list.filters.showTerminated")}
                </button>
              </div>
            )}
          </div>
      ...
      {agents && agents.length === 0 && (
        <EmptyState
          icon={Bot}
          message={t("agents:list.emptyFirst")}
  ...
  return (
    ...
    >
      ...
      <span className="text-[11px] font-medium text-blue-600 dark:text-blue-400">
        {liveCount > 1 ? t("agents:list.liveCount", { count: liveCount }) : t("agents:list.liveNow")}
      </span>
    </Link>
  );
}
