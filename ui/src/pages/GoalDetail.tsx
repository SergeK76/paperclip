...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("common:nav.goals"), href: "/goals" },
      { label: goal?.title ?? goalId ?? t("goals:detail.fallback") }
    ]);
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("goals:detail.tabs.subGoals", { count: childGoals.length })}
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("goals:detail.tabs.projects", { count: linkedProjects.length })}
          </TabsTrigger>
        </TabsList>
